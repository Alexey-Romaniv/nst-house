...
// init Swiper:
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-swiper', {
...
var openModalBtn = document.querySelectorAll("[data-modal-open]");
...
if (modal) {
  ...
  openModalBtn.forEach(function (el) {
...
var reviewSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".reviewSwiper", {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
  loop: true,
  navigation: {
    nextEl: '.review-next',
...
if (form) {
  ...
  (toastr__WEBPACK_IMPORTED_MODULE_0___default().options.progressBar) = true;
  var TG_TOKEN = "5871941331:AAFdm_WlnfgXaRibgrbq8mE4olz2fTXRGaA";
  var CHAT_ID = "-1001973921078";
  form.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var modal, formData, response, name, phone, email, message, url;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            url = "https://api.telegram.org/bot".concat(TG_TOKEN, "/sendMessage?chat_id=").concat(CHAT_ID, "&text=\u0418\u043C\u044F: ").concat(name, "%0A\u0422\u0435\u043B\u0435\u0444\u043E\u043D: ").concat(phone, "%0A\u041F\u043E\u0447\u0442\u0430: ").concat(email, "%0A\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435: ").concat(message);
            _context.next = 13;
          ...
          case 13:
            if (response.ok) {
              ...
              modal.classList.toggle(".is-hidden");
              toastr__WEBPACK_IMPORTED_MODULE_0___default().success("Повідомлення успішно надіслано!");
            } else {
              toastr__WEBPACK_IMPORTED_MODULE_0___default().error("Повідомлення не вдалося надіслати!");
            }
          case 14:
          case "end":
...
/* harmony import */ var _modules_gallery_gallery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %modules%/gallery/gallery */ "./src/blocks/modules/gallery/gallery.js");
...
/* harmony import */ var _modules_modal_modal__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_4__);
...
if (list) {
  var filterList = function filterList(category) {
    list.querySelectorAll(".rent__item").forEach(function (li) {
...
/* harmony import */ var _import_mobile_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./import/mobile-menu */ "./src/js/import/mobile-menu.js");
/* harmony import */ var _import_mobile_menu__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_import_mobile_menu__WEBPACK_IMPORTED_MODULE_2__);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknst_house"] = self["webpackChunknst_house"] || [];
